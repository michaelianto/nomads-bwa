                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                                    ...
                                    <input type="text" name="username" class="form-control mb-2 mr-sm-2 input-username" id="username" required placeholder="Username">
                                    
                                    <label for="nationality" class="sr-only">Nationality</label>
                                    <input type="text" name="nationality" class="form-control mb-2 mr-sm-2 input-username" style="width: 50px" id="nationality" required placeholder="Username">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <p class="payment-instructions">Please complete your payment before to continue this wonderful trip</p>
                            <div class="bank">
